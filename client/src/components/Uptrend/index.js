        ...
        return (<div className="ui container">
            ...
            <div className="four column centered row">
                <div className="ui toggle checkbox">
                    <input type="checkbox" name="option trend" checked={this.props.isOptionTrend} onClick={(e) => { this.props.checkOptionTrend(e.target.checked) }} />
...
const mapStateToProps = (state) => {
    return { isOptionTrend: state.uptrend.optionTrend }
};
