...
const INTIAL_STATE = {
  label: "Index",
  indexList: [
    { key: "s", value: "", text: "--Select--" },
    { key: "n", value: "NIFTY", text: "NIFTY" },
    { key: "bn", value: "BANKNIFTY", text: "BANKNIFTY" },
    { key: "fn", value: "FINNIFTY", text: "FINNIFTY" },
  ],
  index: "indices",
  expiryDates: [],
  data: {},
...
const confReducer = (state = INTIAL_STATE, action) => {
  switch (action.type) {
    case FETCH_DATA:
      ...
      let expiryDates = action.payload.data.records.expiryDates.map(
        (expDate, i) => ({
          key: i,
          value: expDate,
          text: expDate,
    ...
    case RESET_FETCH_DATA:
      return {
        ...state,
        expiryDates: INTIAL_STATE.expiryDates,
        data: INTIAL_STATE.data,
        refreshedAt: INTIAL_STATE.refreshedAt,
      };
    ...
    case CHANGE_MODE:
      ...
      if (action.payload.mode === INTIAL_STATE.formValues.mode) {
        ...
        let indexList = action.payload.data.map((stock, i) => ({
          key: i,
          value: stock,
          text: stock,
        }));
        ...
        return {
          ...INTIAL_STATE,
          formValues: { ...INTIAL_STATE.formValues, mode: action.payload.mode },
          label: "Stock",
          index: "equities",
          indexList,
        };
